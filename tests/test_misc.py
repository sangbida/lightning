...
def test_withdraw_misc(node_factory, bitcoind, chainparams):
    ...
    assert l1.db_query('SELECT COUNT(*) as c FROM our_outputs WHERE spendheight IS NULL AND (reserved_til IS NULL OR reserved_til = 0)')[0]['c'] == 10
    ...
    assert l1.db_query('SELECT COUNT(*) as c FROM our_outputs WHERE spendheight IS NULL AND (reserved_til IS NULL OR reserved_til = 0)')[0]['c'] == 2
    ...
    bitcoind.generate_block(1)
    assert l1.db_query('SELECT COUNT(*) as c FROM our_outputs WHERE spendheight IS NULL AND (reserved_til IS NULL OR reserved_til = 0)')[0]['c'] == 1

    l1.rpc.withdraw(waddr, 'all', minconf=0)
    assert l1.db_query('SELECT COUNT(*) as c FROM our_outputs WHERE spendheight IS NULL AND (reserved_til IS NULL OR reserved_til = 0)')[0]['c'] == 0
