...
static inline void test_watchman_unwatch_scriptpubkey(struct lightningd *ld UNUSED,
						      const char *owner UNUSED,
						      const u8 *scriptpubkey UNUSED,
						      size_t script_len UNUSED)
{
}
#define watchman_unwatch_scriptpubkey test_watchman_unwatch_scriptpubkey
