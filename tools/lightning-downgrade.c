...
/* Generated stub for wallet_scriptpubkey_to_keyidx */
bool wallet_scriptpubkey_to_keyidx(struct lightningd *ld UNNEEDED, struct db *db UNNEEDED,
				   const u8 *script UNNEEDED, size_t script_len UNNEEDED,
				   u32 *index UNNEEDED, enum addrtype *addrtype UNNEEDED)
{ fprintf(stderr, "wallet_scriptpubkey_to_keyidx called!\n"); abort(); }
